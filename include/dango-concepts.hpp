...
dango
{
  ...
  concept is_nullable =
    ...
    dango::is_noexcept_null_equatable<dango::remove_cv<tp_type> const&> &&
    dango::is_noexcept_null_equatable<dango::remove_cv<tp_type>&&> &&
    dango::is_noexcept_constructible<dango::remove_cv<tp_type>, dango::null_tag const&> &&
    dango::is_noexcept_constructible<dango::remove_cv<tp_type>, dango::null_tag&&> &&
